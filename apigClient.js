...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://hi8h16ihkk.execute-api.us-west-2.amazonaws.com/beta';
    ...
    apigClient.chatbotPost = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['body', 'Access-Control-Allow-Origin'], ['body']);
